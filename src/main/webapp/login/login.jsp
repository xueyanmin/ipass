    ...
    <script>
        $(function () {
            ...
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src","${path}/admin/getImgCode?"+new Date().getTime());
            });
           ...
           $("#loginButtonId").click(function () {
              ...
              if (isOk){
                  ...
                  $.ajax({
                      ...
                      type:"post",
                      data:$("#loginForm").serialize(),   //序列化表单的数据 根据name属性
                      success:function (data) {
                       //判断 ：登陆成功 登陆失败
                          if (data.status == "200"){
                              ...
                              //登陆失败 展示错误信息
                              $("#msgDiv").html("<span style='color: darkred;'>"+data.message+"</sapn>")
                          }
