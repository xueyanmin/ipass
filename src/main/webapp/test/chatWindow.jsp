...
<script>
    ...
    $(function(){
        ...
        //接收消息
        goEasy.subscribe({
            channel: "185-chat", //替换为您自己的channel
...
<body>
    <center>
        ...
        <div style="width: 400px;height:500px;border: 3px #acdd4a solid">
            <%--内容展示区域--%>
            <div id="showMsg" style="width: 394px;height: 400px;border:3px #a6e1ec solid"></div>

            <%--输入文本发送区域--%>
            <div style="width: 394px;height: 88px;border: 3px orange solid">
                <%--输入框--%>
                <textarea id="sendMsg" style="width: 300px;height: 88px;border: 3px #ccaadd solid"  ></textarea>
